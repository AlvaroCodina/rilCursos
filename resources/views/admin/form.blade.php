    ...
    <form action="/admin/cursos" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group col-md-12">
            ...
            <!--<textarea name="contenidoHtml" class="form-control" id="contenidoHtml" rows="4" cols="50"  placeholder="Para poner contenido HTML al curso"></textarea>-->
            <textarea class="ckeditor" name="contenidoHtml" id="contenidoHtml" rows="10" cols="80">
                {{ \Illuminate\Support\Facades\Input::old('contenidoHtml') }}
            </textarea>
        </div>
        <div class="col-md-12">
