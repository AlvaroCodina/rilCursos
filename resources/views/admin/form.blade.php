    ...
    <form action="/admin/cursos" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <textarea name="descripcion" class="form-control" id="descripcion" rows="4" cols="50" value="{{ \Illuminate\Support\Facades\Input::old('descripcion') }}" placeholder="Una descripcion del curso"></textarea>
        ...
        <div class="form-group">
            <label for="contenidoHtml">contenidoHTML</label>
